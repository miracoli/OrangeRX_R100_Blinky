...
export LoadConfigTBL_orangerx_r100_blinky_Bank1
export LoadConfigTBL_orangerx_r100_blinky_Bank0
export LoadConfigTBL_orangerx_r100_blinky_Ordered
AREA lit(rom, rel)
LoadConfigTBL_orangerx_r100_blinky_Bank0:
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_orangerx_r100_blinky_Bank1:
...
LoadConfigTBL_orangerx_r100_blinky_Ordered:
