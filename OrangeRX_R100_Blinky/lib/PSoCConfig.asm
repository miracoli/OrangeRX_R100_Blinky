...
export LoadConfig_orangerx_r100_blinky
export _LoadConfig_orangerx_r100_blinky
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_orangerx_r100_blinky
	lcall	LoadConfigTBL_orangerx_r100_blinky_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration orangerx_r100_blinky
;
;    Load configuration registers for orangerx_r100_blinky.
...
;               CUR_PP
;
_LoadConfig_orangerx_r100_blinky:
 LoadConfig_orangerx_r100_blinky:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_orangerx_r100_blinky_Bank0
    mov     X, <LoadConfigTBL_orangerx_r100_blinky_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_orangerx_r100_blinky_Bank1
    mov     X, <LoadConfigTBL_orangerx_r100_blinky_Bank1
